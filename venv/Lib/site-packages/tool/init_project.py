...
content = """"""
os_tool.mkfile(root_path,*['./', 'logs', 'error.log'], content=content)

        
content = """2019-11-15 08:38:38,583 - tools.report.log_tool - INFO - 打开网址： http://www.baidu.com
2019-11-15 08:39:56,393 - tools.report.log_tool - INFO - 打开网址： http://www.baidu.com
2019-11-15 08:39:57,167 - tools.report.log_tool - INFO - id=>kw 中输入： 手机
"""
os_tool.mkfile(root_path,*['./', 'logs', 'info.log'], content=content)
...
class BaseUI:
    ...
    def __init__(self, browser='chrome',timeout=10):
        ...
        if browser == "firefox" or browser == "ff":
            ...
            driver_path = ROOT_PATH + "chrome_driver/chromedriver.exe"
    ...
    def get_locator(self, locator):
        ...
        if "=>" not in locator:
            ...
            if by not in (self.location_type_dict):
                raise TypeError("定位方式错误，请输入正确的定位方式:"
                                "id,name,class_name,xpath,tag_name,css_selector,link_text,partial_link_text")
            if by == "" or value == "":
                raise NameError("locator格式错误，定位方式=>值 示例：'id=>useranme'")
    ...
    def get_element(self,locator):
        ...
        time_out_error = "{}定位元素超时，请尝试其他定位方式".format(local)
        try:
